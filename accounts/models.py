...
class Parent(models.Model):
    ...
    def save(self, *args, **kwargs):
        get_previous_parent = Parent.objects.last()
        if get_previous_parent is None:
            self.parent_id = "P0001"
        else:
            get_previous_parent = get_previous_parent.id + 1
            self.parent_id = "P" + str(get_previous_parent).zfill(4)
        super().save(*args, **kwargs)
